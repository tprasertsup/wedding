...
- [ ] Open `/wedding/guest/guestbook/` on iPhone (iOS 14.5+)
...
- [ ] Visit `/wedding/guest/guestbook/?guest=testtoken123`
- [ ] Submit any blessing
- [ ] Google Sheet row shows `guest_token = testtoken123`
- [ ] Visit `/wedding/guest/guestbook/` (no token)
...
- [ ] Scan with a different phone → opens `/wedding/guest/guestbook/` correctly
...
- [ ] On `/wedding/guest/`, the "Leave a Blessing" card links to `/wedding/guest/guestbook/`
